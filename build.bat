...
echo ============================================================
echo  Triskell Sales Tunnel - construction de l executable
echo ============================================================
...
echo.
pyinstaller triskell_sales_tunnel.spec --noconfirm
if errorlevel 1 (
...
echo  TERMINE
echo ============================================================
echo  Executable : dist\Triskell Sales Tunnel\Triskell Sales Tunnel.exe
echo.
